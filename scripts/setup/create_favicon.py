...
# Load the logo
logo_path = os.path.join('src', 'emailtools', 'web', 'static', 'logo.png')
logo = Image.open(logo_path)

# Create 32x32 favicon (standard size)
favicon_32 = logo.resize((32, 32), Image.Resampling.LANCZOS)
favicon_path = os.path.join('src', 'emailtools', 'web', 'static', 'favicon.ico')
...
favicon_multi_path = os.path.join('src', 'emailtools', 'web', 'static', 'favicon_multi.ico')
