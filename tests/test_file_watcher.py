...
class TestWatchInbox:
    ...
    def test_processes_new_eml_files(self, tmp_path):
        ...
        with patch("intellibox.ingestion.file_watcher.SettingsService"):
    ...
    def test_no_retry_on_failed_files(self, tmp_path):
        ...
        def limited_watch():
            ...
            import intellibox.ingestion.file_watcher as fw
...
class TestWatcherHealth:
    ...
    def test_health_initial_state(self):
        ...
        from intellibox.ingestion.file_watcher import _reset_health, get_watcher_health
    ...
    def test_health_reports_alive_after_poll(self, tmp_path):
        ...
        from intellibox.ingestion.file_watcher import _reset_health, get_watcher_health, watch_inbox
...
class TestSupervisedWatcher:
    ...
    def test_supervised_watcher_restarts_on_crash(self):
        ...
        with patch("intellibox.ingestion.file_watcher.watch_inbox", side_effect=crashing_watch):
    ...
    def test_supervised_watcher_stops_on_keyboard_interrupt(self):
        ...
        with patch("intellibox.ingestion.file_watcher.watch_inbox", side_effect=keyboard_watch):
            supervised_watch(
                inbox_dir=Path("data/inbox"),
                callback=lambda p: None,
                max_restarts=3,
